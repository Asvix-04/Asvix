    ...
    <div className="w-full h-full bg-gradient-to-br from-[#071126] to-[#0b1937] p-4 overflow-hidden relative">
      ...
      >
        <div className="p-4">
          ...
          <div className="w-28 h-3 rounded bg-white/[0.15] mb-4" />
          <div className="flex gap-2">
            <div className="w-20 h-7 rounded-lg bg-space-600/80 border border-space-500/40" />
            <div className="w-20 h-7 rounded-lg bg-white/[0.08] border border-white/[0.15]" />
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2 mb-3">
        {[
          ...
          <div key={f.title} className="bg-white/5 rounded-xl p-2.5 border border-white/[0.08]">
      ...
      {/* Code snippet mockup */}
      <div className="bg-white/[0.04] rounded-xl p-3 border border-white/[0.08] font-mono">
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 rounded-full bg-azure-500/[0.12] blur-2xl pointer-events-none" />
    </div>
  )
}
